...
# app.config['SQLALCHEMY_DATABASE_URL']='mysql://username:password@localhost/class managemengt'
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:@localhost/class managemengt'
db=SQLAlchemy(app)
